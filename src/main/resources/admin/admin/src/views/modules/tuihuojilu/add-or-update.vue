	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="进货价格" prop="jinhuojiage">
					<el-input v-model="ruleForm.jinhuojiage" placeholder="进货价格" clearable  :readonly="ro.jinhuojiage"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="进货价格" prop="jinhuojiage">
					<el-input v-model="ruleForm.jinhuojiage" placeholder="进货价格" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="商品数量" prop="alllimittimes">
					<el-input v-model="ruleForm.alllimittimes" placeholder="商品数量" clearable  :readonly="ro.alllimittimes"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="商品数量" prop="alllimittimes">
					<el-input v-model="ruleForm.alllimittimes" placeholder="商品数量" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.dingdanjine" label="订单金额" prop="dingdanjine">
					<el-input v-model="ruleForm.dingdanjine" placeholder="订单金额" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="date" v-if="type!='info'" label="退货日期" prop="tuihuoriqi">
					<el-date-picker
						format="yyyy 年 MM 月 dd 日"
						value-format="yyyy-MM-dd"
						v-model="ruleForm.tuihuoriqi" 
						type="date"
						:readonly="ro.tuihuoriqi"
						placeholder="退货日期"
					></el-date-picker> 
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-else-if="ruleForm.tuihuoriqi" label="退货日期" prop="tuihuoriqi">
					<el-input v-model="ruleForm.tuihuoriqi" placeholder="退货日期" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="销售工号" prop="xiaoshougonghao">
					<el-input v-model="ruleForm.xiaoshougonghao" placeholder="销售工号" clearable  :readonly="ro.xiaoshougonghao"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="销售工号" prop="xiaoshougonghao">
					<el-input v-model="ruleForm.xiaoshougonghao" placeholder="销售工号" readonly></el-input>
				</el-form-item>
			</template>
		...
		init(id,type) {
			...
			this.$http({
				...
				if (data && data.code === 0) {
					...
					if(json.xiaoshougonghao!=''&&json.xiaoshougonghao && this.$storage.get("role")!="管理员"){
...
var objcross = this.$storage.getObj('crossObj');
      ...
      if(objcross!=null) {
	      objcross.alllimittimes = objcross.alllimittimes - this.ruleForm.alllimittimes
	      if(objcross.alllimittimes<0){
		 ...
		 if(crossrefid && crossuserid) {
			...
			this.$http({ 
				...
				if (data && data.code === 0) { 
					 ...
					 this.$http({
					   url: `tuihuojilu/${!this.ruleForm.id ? "save" : "update"}`,
					   method: "post",
					   data: this.ruleForm
					 }).then(({ data }) => {
					   if (data && data.code === 0) {
						 ...
						 this.parent.tuihuojiluCrossAddOrUpdateFlag = false;
						 this.parent.search();
