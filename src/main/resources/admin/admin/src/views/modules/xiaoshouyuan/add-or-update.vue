	...
	<div class="addEdit-block" style="width: 100%;">
		...
		>
			<template >
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="销售姓名" prop="xiaoshouxingming">
					<el-input v-model="ruleForm.xiaoshouxingming" placeholder="销售姓名" clearable  :readonly="ro.xiaoshouxingming"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="销售姓名" prop="xiaoshouxingming">
					<el-input v-model="ruleForm.xiaoshouxingming" placeholder="销售姓名" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' class="input" v-if="type!='info'"  label="电话" prop="dianhua">
					<el-input v-model="ruleForm.dianhua" placeholder="电话" clearable  :readonly="ro.dianhua"></el-input>
				</el-form-item>
				<el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-else class="input" label="电话" prop="dianhua">
...
export default {
	data() {
		...
		return {
			...
			rules: {
				xiaoshougonghao: [
					{ required: true, message: '销售工号不能为空', trigger: 'blur' },
				],
				mima: [
