<template>
  <div>
    ...
    >  
     <el-row>
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='xiaoshouyuan'"  label="销售工号" prop="xiaoshougonghao">
          <el-input v-model="ruleForm.xiaoshougonghao" readonly              placeholder="销售工号" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='xiaoshouyuan'"  label="销售姓名" prop="xiaoshouxingming">
          <el-input v-model="ruleForm.xiaoshouxingming"               placeholder="销售姓名" clearable></el-input>
        </el-form-item>
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="flag=='xiaoshouyuan'" label="照片" prop="zhaopian">
          <file-upload
          tip="点击上传照片"
          action="file/upload"
          :limit="3"
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}' v-if="flag=='xiaoshouyuan'"  label="性别" prop="xingbie">
        ...
        <el-form-item :style='{"width":"50%","margin":"0 0 20px 0"}'   v-if="flag=='xiaoshouyuan'"  label="电话" prop="dianhua">
...
export default {
  ...
  methods: {
    ...
    onUpdateHandler() {
      if((!this.ruleForm.xiaoshougonghao)&& 'xiaoshouyuan'==this.flag){
      ...
      if((!this.ruleForm.xiaoshouxingming)&& 'xiaoshouyuan'==this.flag){
      ...
      if( 'xiaoshouyuan' ==this.flag && this.ruleForm.dianhua&&(!isMobile(this.ruleForm.dianhua))){
        this.$message.error(`电话应输入手机格式`);
        return
      }
      if( 'xiaoshouyuan' ==this.flag && this.ruleForm.money&&(!isNumber(this.ruleForm.money))){
