...
public class XiaoshouyuanController {
	...
	public R login(String username, String password, String captcha, HttpServletRequest request) {
		XiaoshouyuanEntity u = xiaoshouyuanService.selectOne(new EntityWrapper<XiaoshouyuanEntity>().eq("xiaoshougonghao", username));
		if(u==null || !u.getMima().equals(MD5Util.md5(password))) {
			return R.error("账号或密码不正确");
		}
		String token = tokenService.generateToken(u.getId(), username,"xiaoshouyuan",  "管理员" );
    ...
    public R register(@RequestBody XiaoshouyuanEntity xiaoshouyuan){
    	...
    	XiaoshouyuanEntity u = xiaoshouyuanService.selectOne(new EntityWrapper<XiaoshouyuanEntity>().eq("xiaoshougonghao", xiaoshouyuan.getXiaoshougonghao()));
		if(u!=null) {
			return R.error("注册用户已存在");
		}
		Long uId = new Date().getTime();
		xiaoshouyuan.setId(uId);
                xiaoshouyuan.setMima(MD5Util.md5(xiaoshouyuan.getMima()));
    ...
    public R getCurrUser(HttpServletRequest request){
        ...
        XiaoshouyuanEntity u = xiaoshouyuanService.selectById(id);
    ...
    public R resetPass(String username, HttpServletRequest request){
        ...
        xiaoshouyuanService.updateById(u);
	...
	@IgnoreAuth
    @RequestMapping("/list")
    public R list(@RequestParam Map<String, Object> params,XiaoshouyuanEntity xiaoshouyuan, 
		HttpServletRequest request){
        EntityWrapper<XiaoshouyuanEntity> ew = new EntityWrapper<XiaoshouyuanEntity>();
    ...
    public R update(@RequestBody XiaoshouyuanEntity xiaoshouyuan, HttpServletRequest request){
        //ValidatorUtils.validateEntity(xiaoshouyuan);
	XiaoshouyuanEntity xiaoshouyuanEntity = xiaoshouyuanService.selectById(xiaoshouyuan.getId());
        if(StringUtils.isNotBlank(xiaoshouyuan.getMima()) && !xiaoshouyuan.getMima().equals(xiaoshouyuanEntity.getMima())) {
                xiaoshouyuan.setMima(MD5Util.md5(xiaoshouyuan.getMima()));
        }
